...
Hinton, LeCun, Bengio's work in the 2000s–2010s. Convolutional Neural Networks (CNNs) for vision; Recurrent Neural Networks (RNNs) for sequences. These learned *hierarchical representations* automatically. But even RNNs had a critical flaw for language...
    `,visual:`limitations`},{id:`transformers`,label:`02 — Transformers`,title:`Transformer Architecture`,subtitle:`Attention is all you need — Vaswani et al., 2017`,icon:`⬡`,color:`#4ecdc4`,content:`transformers`,visual:`attention`},{id:`embeddings`,label:`03 — Embeddings`,title:`Embeddings & Semantic Space`,subtitle:`How meaning becomes geometry`,icon:`∷`,color:`#a78bfa`,content:`embeddings`,visual:`embedding`},{id:`gpt_bert`,label:`04 — GPT & BERT`,title:`GPT vs BERT`,subtitle:`Autoregressive generation vs masked language modeling`,icon:`⇌`,color:`#fbbf24`,content:`
...
- **Mistral**, **Gemma**, **Phi**: Efficient smaller models with strong performance
    `,visual:`comparison`},{id:`finetuning`,label:`05 — Fine-tuning`,title:`Model Fine-tuning`,subtitle:`Adapting foundation models for specific tasks`,icon:`⚙`,color:`#f97316`,content:`finetuning`,visual:`finetuning`},{id:`agentic`,label:`06 — Agentic AI`,title:`Agentic AI Frameworks`,subtitle:`LangChain, CrewAI, AutoGen & the agent paradigm`,icon:`⬡`,color:`#34d399`,content:`
...
Break complex tasks into a pipeline of simpler prompts, each feeding into the next. Reduces context overload and makes each sub-prompt easier to optimize independently. The output of Prompt 1 (e.g., extracted entities) becomes the input to Prompt 2 (e.g., relationship classification).
    `,visual:`agent`},{id:`llmops`,label:`07 — LLMOps`,title:`LLMOps`,subtitle:`Production infrastructure for large language models`,icon:`◉`,color:`#60a5fa`,content:`
...
Collect production data → identify failure cases → curate fine-tuning datasets → evaluate new model → deploy with rollout strategy → monitor. This flywheel is what separates products from demos.
    `,visual:`ops`},{id:`responsible`,label:`08 — Responsible AI`,title:`Responsible AI`,subtitle:`Safety, fairness, alignment & societal impact`,icon:`◎`,color:`#f472b6`,content:`
...
High-risk AI systems face mandatory conformity assessments, transparency requirements, and human oversight obligations. Practitioners must understand the legal context of the systems they build.
    `,visual:`responsible`},{id:`multimodal_intro`,label:`09 — Multimodal AI`,title:`Multimodal AI`,subtitle:`Teaching models to see, hear, and reason across modalities`,icon:`⬢`,color:`#e879f9`,content:`
